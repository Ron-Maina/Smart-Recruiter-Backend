...
from app.models import  Interviewees, Recruiters, Assessments, IntervieweeAssessment, Questions, Answers
...
api.add_resource(IntervieweeAssessments, '/intassessments')
