...
Revision ID: 2a501fcdf5a0
Revises: 
Create Date: 2023-10-31 20:17:49.441123
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('bdd_text', sa.String(length=500), nullable=False),
    sa.Column('pseudocode_text', sa.String(length=500), nullable=False),
    sa.Column('code_text', sa.String(length=500), nullable=False),
    sa.Column('assessment_id', sa.Integer(), nullable=True),
    sa.Column('interviewee_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['assessment_id'], ['assessments.id'], name=op.f('fk_whiteboard_assessment_id_assessments')),
